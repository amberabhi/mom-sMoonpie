...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Product Size</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Add Product Size</h4>
                    <form method="POST" action="{{ route('admin.sizes.store') }}" class="row"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6 mb-3">
                            <label for="size" class="form-label">Size {!! $required_span !!}</label>
                            <input type="text" class="form-control" id="size" name="size"
                                value="{{ old('size') }}" placeholder="Ex. 8-10 Years" required>
                            @error('size')
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <a href="{{ route('admin.sizes.index') }}" class="btn btn-dark">Back</a>
                        </div>
                    </form>
                </div>
            </div>
