...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Add Promocode</h4>
                    <form method="POST" action="{{ route('admin.promocodes.store') }}" class="row"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="status2" name="is_active" class="form-control" required>
                                <option value="">Please Select</option>
