    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Marquee Items (Rotating Bar)</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-12 mb-3">
                        <a href="{{ route('admin.marquee-items.create') }}" class="btn btn-dark">Add Marquee Item</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>{{$status}}</td>
                                        <td>
                                            <a href="{{ route('admin.marquee-items.edit', $item->id) }}"
                                                class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route('admin.marquee-items.destroy', $item->id) }}"
