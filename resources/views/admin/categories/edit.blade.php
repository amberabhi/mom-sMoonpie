                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="name" class="form-label">Category Name {!! $required_span !!}</label>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="status2" name="status" class="form-control" required>
                                <option value="1" @if ($category->is_active == 1) @selected(true) @endif>Active</option>
                                <option value="0" @if ($category->is_active == 0) @selected(true) @endif>Inactive</option>
                            </select>
                            @error('status')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
