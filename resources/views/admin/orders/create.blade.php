                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="nav_category" name="nav_category">
                                <option value="" selected disabled>-- Select an Option --</option>
                                <option value="just-in-499">Just in 499</option>
                                <option value="shop-for-boys">Shop for Boys</option>
                                <option value="shop-for-girls">Shop for Girls</option>
                                <option value="shop-for-infants">Shop for Infants</option>
